...
def reset_test_settings(
    ...
    monkeypatch.delenv("GOFRSEC_SIGNING_KEY_PATH", raising=False)
    monkeypatch.delenv("GOFRSEC_SIGNING_VAULT_PATH", raising=False)
    monkeypatch.delenv("GOFRSEC_TOKEN_ISSUER", raising=False)
    monkeypatch.delenv("GOFRSEC_TOKEN_DEFAULT_LIFETIME_S", raising=False)
